...
from MMACNet.modules.preprocessors import ClinicalNotePreprocessor
from MMACNet.utils.configuration import Config
from MMACNet.utils.mapper import ConfigMapper
from MMACNet.utils.misc import html_word_importance
...
with st.form("my_form"):
    ...
    with col2:
        ...
        if token_idxs and len(token_idxs) >= config.demo.min_input_len:
            ...
            if config.demo.use_gpu:
                batch_input = batch_input.to(mps_device)
